...
export const createHelpRequest = (requestData) => {
  ...
  return helpApi.post('/request', requestData, {
    headers: {
      // Axios will automatically set Content-Type to multipart/form-data if data is FormData
      // 'Content-Type': 'multipart/form-data', // Only set this if not using FormData directly
    }
  });
};
export const createHelpOffer = (offerData) => helpApi.post('/offer', offerData); // Added this line
...
export default {
  ...
  getAllHelpRequests,
  createHelpRequest,
  createHelpOffer, // Added this line
  getHelpRequestById,
  updateHelpRequest,
  deleteHelpRequest,
  searchHelpRequests
