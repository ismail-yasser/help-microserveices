...
echo - Access services: scripts\get-service-urls.bat
echo - Manage project: scripts\manage-project.bat
echo.
echo For full management capabilities, use: scripts\manage-project.bat
echo.
goto :end
