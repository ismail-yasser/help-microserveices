...
kubectl exec -it deployment/frontend -- nslookup user-service 2>nul | findstr "Address" >nul
if %errorlevel% equ 0 (
...
kubectl exec -it deployment/frontend -- nslookup help-service 2>nul | findstr "Address" >nul
if %errorlevel% equ 0 (
