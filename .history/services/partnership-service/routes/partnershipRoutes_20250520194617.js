...
// Search partnerships
router.get('/search', partnershipController.searchPartnerships);
...
router.post('/:id/members', authMiddleware, partnershipController.addMember);

// Remove a member from a partnership
router.delete('/:id/members/:memberId', authMiddleware, partnershipController.removeMember);
